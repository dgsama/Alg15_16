...
public class FakeCoinsTest {
	...
	@Test
	public void test() {
		for (int i = 100; i < 1000; i++) { // Coins in the bag (bags between 100
											// and 1000 coins)
