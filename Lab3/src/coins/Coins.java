...
public class Coins {
	 ...
	 * 
	 * @param coins
	 *            Array to create the group con coins
	 */
	 ...
	 * 
	 * @param leftSideStarts
	 *            Index of the first element to the left plate
	 * @param leftSideEnds
	 *            Index of the last element to the left plate
	 * @param rightSideStarts
	 *            Index of the first element to the right plate
	 * @param rightSideEnds
	 ...
	 * 
	 * @param starts
	 *            Index of the initial element to be printed
	 * @param ends
	 *            Index of the last element to be printed
	 */
	void prints(int starts, int ends) {
		// Prints the number of coins of the range and its indexes
		System.out.println("NumOfCoins = " + (ends - starts + 1) + " ("
				+ starts + "," + ends + ")");
